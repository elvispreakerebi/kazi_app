...
export const deleteLessonPlanHandler = async (ctx: any, req: Request) => {
  ...
  try {
    const result = await ctx.runMutation(api.functions.lessonPlans.deleteLessonPlan.deleteLessonPlan, {
